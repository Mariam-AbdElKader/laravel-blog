<form action="{{ route('admin.posts.comments.update', [$post, $comment]) }}" method="POST"
     ...
     <div class="mb-4">
         ...
         <input type="text" name="name" id="name"
             ...
             required value="{{ old('name', $comment->name) }}">
         @error('name')
     ...
     <div class="flex justify-end space-x-4">
         ...
         <button type="submit" class="px-6 py-2 bg-gradient-to-r from-purple-500 to-indigo-500 text-white rounded-md shadow hover:scale-105 transition">
            Update Comment
        </button>
     </div>
 </form>
